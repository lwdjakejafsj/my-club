package com.luowei.gateway.auth;

import cn.dev33.satoken.stp.StpInterface;
import com.google.common.reflect.TypeToken;
import com.google.gson.Gson;
import com.luowei.gateway.entity.AuthPermission;
import com.luowei.gateway.entity.AuthRole;
import com.luowei.gateway.redis.RedisUtil;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getAuth(String prefix,String loginId) {
        ...
        if (authRolePrefix.equals(prefix)) {
            List<AuthRole> roleList = new Gson().fromJson(value, new TypeToken<List<AuthRole>>() {
            }.getType());
